...
const api: DesktopApi = {
  ...
  sources: {
    ...
    searchMusicMany: (queries, limitPerQuery, popularityLevel, scope) => ipcRenderer.invoke(IPC_CHANNELS.searchManyMusicSources, queries, limitPerQuery, popularityLevel, scope) as Promise<YouTubeSource[][]>,
